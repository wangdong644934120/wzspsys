    ...
    this.onSetData = function (data) {//设置数据
        ...
        if (data != null && data.data != null && data.data.length > 0) {
            for (var i = 0; i < data.data.length; i++) {
                ...
                var des = "<div style='width:280px;'>" + data.data[i].des + "</div>";
                ...
                ul_div.append(des + "<div style='width:200px;'>" + data.data[i].sourse + "</div><div style='width:200px;'>" + data.data[i].time + "</div>");
            }
