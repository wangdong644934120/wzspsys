...
public class DictController extends BaseController {
     ...
     */
    @RequestMapping("")
    public String index(@RequestParam("dictTypeId") String dictTypeId, Model model) {
     ...
     */
    @RequestMapping("/add")
    public String add(@RequestParam("dictTypeId") String dictTypeId, Model model) {
        model.addAttribute("dictTypeId", dictTypeId);
     ...
     */
    @RequestMapping("/edit")
    public String edit(@RequestParam("dictId") String dictId, Model model) {
    ...
    @ResponseBody
    public List<ZTreeNode> ztree(@RequestParam("dictTypeId") String dictTypeId, @RequestParam(value = "dictId", required = false) String dictId) {
    ...
    @ResponseBody
    public List<Dict> getDropdown(@RequestParam("dictTypeId") String dictTypeId){
        //从缓存中获取
        List<Dict> list=ConstantFactory.me().findByDictType(dictTypeId);
        return list;
    }
}
