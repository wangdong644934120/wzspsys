...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public void setProjects(Long userId, String projectIds) {
        this.baseMapper.deleteProjectOfOneUser(userId);
        this.baseMapper.setProjects(userId, Arrays.asList(projectIds.split(",")));
    }

    public void setGovunits(Long userId, String govunitIds) {
