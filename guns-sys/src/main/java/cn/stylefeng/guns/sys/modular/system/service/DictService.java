...
public class DictService extends ServiceImpl<DictMapper, Dict> {
    ...
    public void add(DictParam param) {
        ...
        //code当ID用
        entity.setDictId(entity.getCode());
        this.save(entity);
        //删除缓存
    ...
    public void delete(DictParam param) {
        ...
        //删除字典的所有子级
        List<String> subIds = getSubIds(param.getDictId());
        if (subIds.size() > 0) {
     ...
     */
    public List<ZTreeNode> dictTreeList(String dictTypeId, String dictId) {
        if (dictTypeId == null) {
        ...
        //获取dict的所有子节点
        List<String> subIds = getSubIds(dictId);
     ...
     */
    public DictResult dictDetail(String dictId) {
    ...
    private List<String> getSubIds(String dictId) {
    ...
    public List<Dict> getDictListByType(@Param("dictTypeId") String dictTypeId){
        return this.baseMapper.getDictListByType(dictTypeId);
    }
}
