...
layui.use(['form', 'admin', 'ax'], function () {
    ...
    //获取详情信息，填充表单
    var ajax = new $ax(Feng.ctxPath + "/activityType/detail?id=" + Feng.getUrlParam("id"));
    var result = ajax.start();
    form.val('activityTypeForm', result.data);

    //表单提交事件
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.ctxPath + "/activityType/editItem", function (data) {
            Feng.success("更新成功！");
