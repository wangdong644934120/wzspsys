package cn.stylefeng.guns.generator.core.generator.guns.mybatisplus;

import cn.stylefeng.guns.generator.core.generator.base.AbstractMpGenerator;
...
public class GunsMpGenerator extends AbstractMpGenerator {
    ...
    protected void beforeGeneration() {
        ...
        globalConfig.setIdType(IdType.UUID);//默认UUID
